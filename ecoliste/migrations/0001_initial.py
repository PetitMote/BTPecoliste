# Generated by Django 3.2.4 on 2021-06-15 08:40
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=50, unique=True, verbose_name="Nom"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "website",
                    models.URLField(
                        blank=True, db_index=True, unique=True, verbose_name="Site web"
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="Nom de l'origine"
                    ),
                ),
            ],
            options={
                "verbose_name": "Origine écologiques",
                "verbose_name_plural": "Origines écologiques",
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        db_index=True, default=99, verbose_name="Ordre d'affichage"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="ecoliste.Address",
                        verbose_name="Adresse de production",
                    ),
                ),
                (
                    "biobased_material",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "firstname",
                    models.CharField(
                        db_index=True, max_length=50, verbose_name="Prénom"
                    ),
                ),
                (
                    "surname",
                    models.CharField(
                        db_index=True, max_length=50, verbose_name="Nom de famille"
                    ),
                ),
                (
                    "description",
                ...
                (
                    "phone1",
                    models.CharField(
                        db_index=True, max_length=25, verbose_name="Téléphone 1"
                    ),
                ),
                (
                    "phone2",
                    models.CharField(
                        db_index=True, max_length=25, verbose_name="Téléphone 2"
                    ),
                ),
                (
                    "mail",
                    models.EmailField(
                        db_index=True, max_length=254, verbose_name="Adresse mail"
                    ),
                ),
                (
                    "enterprise",
            ...
            options={
                ...
                "unique_together": {("firstname", "surname", "mail")},
            },
        ),
    ]
